...
JA: dict[str, str] = {
    ...
    "manager.help": "機関。迎え入れは onboard、以後の手当てはここ",
    "client.help": "主体と資格情報",
    # 共通の語
    "opt.manager_id": "機関 id",
    "opt.note": "運用の記録",
    "opt.only_naan": "この NAAN のものだけ",
    "word.unassigned": "(機関未割当)",
    ...
    # manager
    "manager.list.help": "機関を並べる。**id は他のコマンドの入力になる。**",
    "manager.commitment.help": "機関の約束の水準を言い直す。\n\n"
                               "**これは `??` でそのまま公開される。** 機関が述べたことだけを"
    ...
    "manager.commitment.need_args": "機関 id と水準が要ります（--list で一覧）",
    # client add
    ...
    "succeed.predecessor": "承継元の機関 id",
    "succeed.successor": "承継先の機関 id",
    "succeed.retire": "移した shoulder の新規採番を止める",
    "succeed.done": "{successor} が承継しました: {moved}",
    "succeed.revoked": "停止した資格情報: {revoked}",
    "depart.help": "機関の離脱。**新規採番は止め、解決は続ける。**",
    "depart.manager": "離脱する機関 id",
    "depart.resolver": "転送先を機関のリゾルバに一括で向け直す。"
...
EN: dict[str, str] = {
    ...
    "manager.help": "Institutions. Onboarding is `onboard`; everything after is here",
    "client.help": "Principals and credentials",
    "opt.manager_id": "institution id",
    "opt.note": "an operational note",
    "opt.only_naan": "only those under this NAAN",
    "word.unassigned": "(no institution)",
    ...
    "onboard.help": "Onboard an institution and delegate one namespace to it. "
                    "**The two always happen together.**\n\n"
                    "Confirm `--commitment` with the institution as you onboard it. "
                    "**Left at the default, `??` publishes, in the institution's name, "
                    "a level the institution never stated.**",
    "onboard.name": "institution name (internal only; never published)",
    ...
    "onboard.default_warning": "↑ Left at the default. Confirm it with the institution "
    ...
    "manager.list.help": "List institutions. **The ids are input to other commands.**",
    "manager.commitment.help": "Restate an institution's commitment level.\n\n"
                               "**This is published verbatim by `??`.** Put in only what the "
                               "institution has stated — publishing a default as a declaration "
    ...
    "manager.commitment.need_args": "an institution id and a level are required "
                                    "(--list to see them)",
    ...
    "succeed.predecessor": "id of the institution being succeeded",
    "succeed.successor": "id of the institution succeeding it",
    ...
    "depart.help": "An institution leaves. **Minting stops; resolution continues.**",
    "depart.manager": "id of the departing institution",
    "depart.resolver": "repoint all targets at the institution's own resolver, "
